...
public class ContactFrag extends ListFragment {
	...
	public void onCreate(Bundle saved) {
		...
		//currently this button is invisible so this code is never reached, here for later implementation
		...
		if (cur.getCount() > 0 /*&& !daoinstance.isContactsCreated()*/) 
		{
			daoinstance.setContactsCreated(true);
