...
public class PhotoIntentActivity extends Activity {
	...
	// Set the default naming convention for images
	...
	private File getAlbumDir() {
		...
		// Check for null and get the storage directory
		...
		// Return a path to the directory as a File
		return storageDir;
	}
	...
	private void galleryAddPic() throws IOException {
		...
		// Adds the current photo to the gallery
	...
	private void dispatchTakePictureIntent(int actionCode) {
		...
		// Opens the intent for taking a photo 
	...
	// Code for handling small photos
	...
	// Handles the photos for our app
	private void handleBigCameraPhoto() throws IOException {

		// If the path exists
		if (mCurrentPhotoPath != null) {
			
			// Set the custom path for passing back to parent Activity
	...
	// Listeners that call the intent when clicked
 ...
 */
		...
		saveButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// If a path to a picture exists
				if (!bundlePhotoPath.isEmpty())
				{
					// If the user has input a name in the EditTet
					if (!bundleName.getText().toString().isEmpty())
					{	
						// pass the path and name back to parent
		...
		// Calls outside classes to comply with multiple SDK Versions
	...
	public void onResume()
	{
		...
		// Don't allow the save button to be clicked if a picture is not taken
